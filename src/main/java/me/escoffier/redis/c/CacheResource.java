 ...
 * <code><pre>
 *     > mvn quarkus:dev
 *     > http POST :8080/cache id1:=3 id2:=23 => take time
 *     > http POST :8080/cache id1:=3 id2:=23 => immediate response
 * </pre></code>
 */
@Path("/cache")
public class CacheResource {
    ...
    public CacheResource(SupesRepository repository, FightSimulator simulator, RedisDataSource ds) {
